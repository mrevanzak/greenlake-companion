...
class PDFBuilder {
  ...
  private func drawSingleTask(task: LandscapingTask, images: [UIImage], in frame: CGRect) {
  ...
  private func calculateTaskHeight(task: LandscapingTask, images: [UIImage], width: CGFloat) -> CGFloat {
  ...
  private func _drawWrappingImageList(images: [UIImage], maxImageHeight: CGFloat = 120.0) {
  ...
  private func drawText(_ text: String, font: UIFont, alignment: NSTextAlignment = NSTextAlignment.center, color: UIColor = UIColor.black, rectLocation: CGRect? = nil) {
    let paragraphStyle = NSMutableParagraphStyle()
    paragraphStyle.alignment = alignment
  ...
  private func _drawSigningTemplate() {
