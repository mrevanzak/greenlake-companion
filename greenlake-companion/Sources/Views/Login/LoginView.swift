  ...
  private var brandingSection: some View {
    VStack(spacing: 24) {
      ...
      ZStack {
        ...
        Image("AppLogo")
          .resizable().frame(width: 120, height: 120).clipShape(.circle)
          .accessibilityLabel("Icon Aplikasi")
      }
      ...
      Text("End-to-End Landscaping Management Solution")
        .font(.system(size: 17))
        .foregroundColor(.secondary)
        .multilineTextAlignment(.center)
        .padding(.horizontal, 40)
        .accessibilityLabel("Aplikasi untuk manajemen landscape")
      ...
      VStack(spacing: 20) {
        VStack(alignment: .leading, spacing: 6) {
          ...
          TextField("", text: $viewModel.email)
            ...
            .submitLabel(.next)
            .accessibilityLabel("Email field, silahkan input email disini")
            .onSubmit {
        ...
        VStack(alignment: .leading, spacing: 6) {
          ...
          SecureField("", text: $viewModel.password)
            ...
            .submitLabel(.go)
            .accessibilityLabel("Password field, silahkan input password disini")
            .onSubmit {
