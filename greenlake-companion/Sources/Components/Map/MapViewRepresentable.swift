...
struct MapViewRepresentable: UIViewRepresentable {
    ...
    @Binding var mapView: MKMapView?
       @Binding var mapType: CustomMapType
    ...
    init(
        ...
        mapType: Binding<CustomMapType> = .constant(.satellite),
                mapView: Binding<MKMapView?> = .constant(nil)
    ) {
    ...
    private func configureMapAppearance(_ mapView: MKMapView) {
        ...
        mapView.mapType = mapType.mkMapType // Use the binding value
